...
function next2() {
    ...
    if (num2 == 2) {
        let slide1 = document.getElementById('picc2').innerHTML = "<h1>Как выжить бизнесу в сети</h1><br><p>Мероприятие будет полезно предпринимателям, специалистам,<br>занимающимся продвижением товаров и услуг в интернете, маркетологам, SMM...</p>";
    }
    slide.src = a2[num2];
